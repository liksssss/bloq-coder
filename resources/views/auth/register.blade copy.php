            ...
            <div class="front">
                <div class="text">
                    ...
                    <a style="text-decoration: none" href="{{ route('blog.home') }}">
                        <span class="text-1">SIMP@N SPBE</span>
                        <br>
                        <span class="text-2">Kabupaten Pekalongan</span>
                    </a>
                </div>
            </div>
            <div class="back">
                ...
                <div class="register-form">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="input-boxes">
                            ...
                            <p>Jika Sudah Punya Akun <a href="{{ route('login') }}" class="login-link">Login disini!</a>
                            </p>
                            <!-- Button container -->
