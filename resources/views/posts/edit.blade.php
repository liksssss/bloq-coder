             ...
             <div class="card-body">
                <div class="row d-flex align-items-stretch">
                   <div class="col-md-8">
                      ...
                      <!-- author -->
                      <div class="form-group">
                         <label for="input_post_author" class="font-weight-bold">
                            {{ trans('posts.form_control.input.author.label') }}
                         </label>
                         <input id="input_post_author" value="{{ old('author', $post->author)}}" name="author" type="text" 
                         class="form-control @error('author') is-invalid @enderror"
                            placeholder="{{ trans('posts.form_control.input.author.placeholder')}}" />
                            @error('author')
                                <span class="invalid-feedback">
                                    <strong>
                                        {{ $message}}
