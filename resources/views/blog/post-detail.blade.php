                        ...
                        <div class="text-right">
                            @if (Auth::check() &&
                                ...
                                <form id="delete-comment-{{ $comment->id }}" method="post"
                                    ...
                                    @csrf
                                    @method('DELETE')
                                    <!-- Tampilkan tombol delete untuk Admin dan Manajer Konten -->
                                    <button type="button" style="width: 35px; height: 35px;" class="btn btn-sm btn-danger"
                                        onclick="confirmDeleteComment('{{ $comment->id }}')">
                                        <i class="fas fa-trash"></i>
                                    </button>
                                    <!-- Tampilkan tombol edit hanya untuk pemilik komentar -->
